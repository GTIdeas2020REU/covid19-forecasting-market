...
if __name__ == "__main__":
    ...
    scheduler.add_job(func=load_all_org_forecasts, trigger="interval", days=1, max_instances=2)
    scheduler.add_job(func=update_errors, trigger="interval", days=1, max_instances=3)
    scheduler.add_job(func=update_org_errors, trigger="interval", days=1, max_instances=3)
